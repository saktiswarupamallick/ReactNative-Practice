...
async function checkCliVersionAsync() {
  ...
  _log().default.nestedWarn((0, _boxen().default)(_chalk().default.red(`${_chalk().default.bold('The global expo-cli package has been deprecated.')}\n\nThe new Expo CLI is now bundled in your project in the ${_chalk().default.bold('expo')} package.\nLearn more: https://blog.expo.dev/the-new-expo-cli-f4250d8e3421.\n\nTo use the local CLI instead (recommended in SDK 46 and higher), run:\n\u203A ${_chalk().default.bold(`npx expo <command>`)}`), {
    borderColor: 'red',
    padding: 1
  }));
}
